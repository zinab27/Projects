...
const titledec = decodeURIComponent(urlParams.get("name")).trim();
...
if (bookId) {
  ...
  document.getElementById("myFile").text = photodec; // n
}
...
submit.addEventListener("click", async function (e) {
  ...
  if (operation == "update") {
    ...
    fetch(
      `./update_book/?id=${bookId}&genre=${genre.value}&author=${author.value} 
